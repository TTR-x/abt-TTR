...
export default function DashboardPage() {
  ...
  const pointsThisMonth = safeClients
    .filter(client => {
      const activationDate = new Date(client.referralDate); // Assuming referralDate is when they become active for points
      return client.isActive && isWithinInterval(activationDate, { start: startOfCurrentMonth, end: endOfCurrentMonth });
    })
